...
######################## INPUTS ##############################################################################
counts   = read.table('/Users/robertvanagas/Desktop/HGSC scRNAseq/pseudobulk/pseudobulk_tumorcells_counts.tsv', header=TRUE, row.names=1, sep="\t", check.names=FALSE)
metadata = read.csv('/Users/robertvanagas/Desktop/HGSC scRNAseq/pseudobulk/pseudobulk_tumorcells_metadata.csv',  header=TRUE, row.names=1, check.names=FALSE)
...
ggsave("/Users/robertvanagas/Desktop/S1B.png", plot = volcano_plot, width = 90, height = 90, units = "mm", bg = "white", dpi = 300)
